...
<tbody>	<tr>
		...
		<tr>
			...
			<td width="193">&nbsp;</td>
			<td width="184" bgcolor="#FFFFFF"><span class="style4">请输入用户名</span></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" name="realname" onBlur="checkRealname()"></input></td>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<td><input type="text" name="age" onBlur="checkAge()"></input></td>
			<td>&nbsp;</td>
...
<td><input type="text" name="commMethod" onBlur="checkCommMethod()"></td>
<td>&nbsp;</td>
